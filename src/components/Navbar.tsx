        ...
        <nav
            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul className="flex flex-col p-4 mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                    <li>
                        <Link href="/"
                              className="mx-2 text-blue-900 text-base link-underline">Welkom</Link>
                    </li>
                    <li>
                        <Link href="/contact"
                              className="mx-2 text-blue-900 text-base link-underline">Contact</Link>
                    </li>
                    <li>
                        <Link href="/activiteiten"
                              className="mx-2 text-blue-900 text-base link-underline">Activiteiten</Link>
                    </li>
                    <li>
                        <Link href="/bannen"
                              className="mx-2 text-blue-900 text-base link-underline">Bannen</Link>
                    </li>
                    <li>
                        <Link href="/heikleuter"
                              className="mx-2 text-blue-900 text-base link-underline">Heikleuter</Link>
                    </li>
                    <li>
                        <Link href="/fotos"
                              className="mx-2 text-blue-900 text-base link-underline">Foto's</Link>
                    </li>
                    <li>
                        <Link href="/over"
                              className="mx-2 text-blue-900 text-base link-underline">Over
                            Ons</Link>
                    </li>
                    <li>
                        <Link href="/op-kamp"
                              className="mx-2 text-blue-900 text-base link-underline">Op
                            Kamp</Link>
                    </li>
                    <li>
                        <Link href="/#events"
                              className="mx-2 text-blue-900 text-base link-underline">Evenementen</Link>
                    </li>
                </ul>
            </div>
            <div className="hidden justify-between mr-10 md:flex">
                <button type="button"
                    ...
                    <a href="https://www.facebook.com/KSAFrisseHeikrachtBree/?view_public_for=863051483707219"
                       target="_blank">
